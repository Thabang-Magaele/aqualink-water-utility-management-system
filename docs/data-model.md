...
| `invoices/{id}`                   | invoiceNumber, accountId, customerId, billingPeriod, previous/current reading, consumption, tariffRate, amount, status, dueDate, paidAt                               | Billing (Cloud Function in Phase 13) |
